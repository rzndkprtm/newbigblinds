<%@ Page Language="VB" AutoEventWireup="false" CodeFile="500.aspx.vb" Inherits="Error_500" Title="Error 500" %>
        ...
        <div id="error">
            <div class="error-page container">
                <div class="col-md-8 col-12 offset-md-2">
                    <img class="img-error" runat="server" src="~/Assets/images/error/error-500.png" alt="Not Found">
