<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SkylineOcean.aspx.vb" Inherits="Order_SkylineOcean" MasterPageFile="~/Site.Master" Title="Skyline Ocean Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../Scripts/Order/SkylineOcean.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>
