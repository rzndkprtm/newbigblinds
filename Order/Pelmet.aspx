<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pelmet.aspx.vb" Inherits="Order_Pelmet" MasterPageFile="~/Site.Master" Title="Pelmet Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../Scripts/Order/Pelmet.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>
