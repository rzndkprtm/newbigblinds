<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Linea.aspx.vb" Inherits="Order_Linea" MasterPageFile="~/Site.Master" Title="Linea Valance Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div class="form form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div id="divdetail">
                                        ...
                                        <div class="row" id="divfabrictype">
                                            <div class="col-12 col-sm-12 col-lg-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-12 col-lg-5 form-group">
                                                <select id="brackettype" class="form-select">
                                                    <option value=""></option>
                                                    <option value="Single Roller">Single Roller</option>
                                                    <option value="Dual Roller">Dual Roller</option>
                                                    <option value="Panel Screen - 3 Tracks">Panel Screen - 3 Tracks</option>
                                                    <option value="Panel Screen - 4 Tracks">Panel Screen - 4 Tracks</option>
                                                    <option value="Panel Screen - 5 Tracks">Panel Screen - 5 Tracks</option>
                                                    <option value="Vertical">Vertical</option>
                                                    <option value="Vertical with Extension">Vertical with Extension</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12 col-sm-12 col-lg-3">
                                                <label>Is Blind In</label>
                                            </div>
                                            <div class="col-12 col-sm-12 col-lg-3 form-group">
                                                <select id="isblindin" class="form-select">
                                                    <option value=""></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-12 col-lg-4 form-group" id="divreturnlengthvalue">
                                                <div class="input-group">
    ...
    <script src="../Scripts/Order/Linea.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>
