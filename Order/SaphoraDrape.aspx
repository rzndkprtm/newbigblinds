<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SaphoraDrape.aspx.vb" Inherits="Order_SaphoraDrape" MasterPageFile="~/Site.master" Title="Shapora Drape Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../Scripts/Order/Saphora.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>
