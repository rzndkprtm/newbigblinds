<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EvolveOcean.aspx.vb" Inherits="Order_EvolveOcean" MasterPageFile="~/Site.Master" Title="Evolve Ocean Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../Scripts/Order/EvolveOcean.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>