<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Outdoor.aspx.vb" Inherits="Order_Outdoor" MasterPageFile="~/Site.master" Title="Outdoor Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../Scripts/Order/Outdoor.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>