<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Design.aspx.vb" Inherits="Order_Design" MasterPageFile="~/Site.Master" Title="Design Shades Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="form-body">
                                    ...
                                    <div id="divdetail">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-sm-12 col-lg-4 form-group" id="divcustomwandlength">
                                                <div class="input-group">
    ...
    <script src="../Scripts/Order/Design.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>