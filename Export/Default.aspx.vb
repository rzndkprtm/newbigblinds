    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs)
        ...
        Try
            If msgError.InnerText = "" Then
                Dim url As String = String.Format("boe?startdate={0}&enddate={1}&type={2}&status={3}&action=test", txtStartDate.Text, txtEndDate.Text, ddlOrderType.SelectedValue, ddlOrderStatus.SelectedValue)
