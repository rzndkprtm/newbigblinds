        ...
        If Not String.IsNullOrEmpty(e.CommandArgument) Then
            ...
            If e.CommandName = "Ubah" Then
                ...
                Try
                    ...
                    Dim myData As DataSet = settingClass.GetListData("SELECT * FROM Promos WHERE Id='" & lblId.Text & "'")
                    ...
                    If Not myData.Tables(0).Rows(0).Item("StartDate").ToString() = "" Then
                        txtStartDate.Text = Convert.ToDateTime(myData.Tables(0).Rows(0).Item("StartDate")).ToString("yyyy-MM-dd")
                    End If

                    If Not myData.Tables(0).Rows(0).Item("EndDate").ToString() = "" Then
                        txtEndDate.Text = Convert.ToDateTime(myData.Tables(0).Rows(0).Item("EndDate")).ToString("yyyy-MM-dd")
                    End If
            ...
            ElseIf e.CommandName = "Log" Then
                ...
                Try
                    gvListLogs.DataSource = settingClass.GetListData("SELECT * FROM Logs WHERE DataId='" & dataId & "' AND Type='Promos' ORDER BY ActionDate DESC")
                    gvListLogs.DataBind()
