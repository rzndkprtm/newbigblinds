        ...
        If Not String.IsNullOrEmpty(e.CommandArgument) Then
            ...
            If e.CommandName = "Detail" Then
                ...
                Try
                    ...
                    Dim myData As DataSet = settingClass.GetListData("SELECT * FROM PriceProductGroups WHERE Id='" & lblId.Text & "'")
            ...
            ElseIf e.CommandName = "Log" Then
                ...
                Try
                    gvListLogs.DataSource = settingClass.GetListData("SELECT * FROM Logs WHERE DataId='" & dataId & "' AND Type='ProductGroups' ORDER BY ActionDate DESC")
                    gvListLogs.DataBind()
