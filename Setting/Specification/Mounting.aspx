<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mounting.aspx.vb" Inherits="Setting_Specification_Mounting" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Mounting" %>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 form-group">
                            <label class="form-label">Blind Name</label>
                            <asp:ListBox runat="server" ID="lbBlind" CssClass="choices form-select multiple-remove" SelectionMode="Multiple"></asp:ListBox>
                        </div>
                    </div>
