<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_General_Newsletter_Default" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Newsletter" %>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            for (let i = 1; i < gv.rows.length; i++) {
                ...
                row.addEventListener('click', function (e) {
                    ...
                    const btn = this.querySelector("a[id*='linkPreview']");
                    if (btn) btn.click();
                });
            }
        });
