<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Level.aspx.vb" Inherits="Setting_General_Level" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Level Access" %>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title white">Delete Level</h5>
                </div>
